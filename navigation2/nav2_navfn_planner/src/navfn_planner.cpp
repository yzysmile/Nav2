  ...
  nav_msgs::msg::Path & plan)
{
  // clear the plan, just in case
   // nav_msgs::msg::Path 中包含了 std_msgs/Header header 和 geometry_msgs/PoseStamped[] poses
    // geometry_msgs/PoseStamped[]包含了 std_msgs/Header header 和 geometry_msgs/Pose pose
     // geometry_msgs/Pose 包含了 geometry_msgs/Point position 和 geometry_msgs/Quaternion orientation
      // geometry_msgs/Point 由 float64 x y z 组成 
      // geometry_msgs/Quaternion orientation 由 float64 x y z w组成(四元素) 
  plan.poses.clear();
